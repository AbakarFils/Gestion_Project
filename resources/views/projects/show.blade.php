            ...
            <div class="row container-fluid">
                ...
                <form method="post" action="{{ route('comments.store') }}">
                    ...
                    <div class="form-group">
                        <label for="comment-content">Commentaires</label>
                    ...
                    <div class="form-group">
                        <label for="comment-content">Preuve du travail fait (Url/Photos)</label>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3 pull-right">
        ...
        <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
                <li><a href="/laravel/public/projects/{{ $project->id }}/edit">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        Edit</a></li>
                <li><a href="/laravel/public/projects/create"><i class="fa fa-plus-circle" aria-hidden="true"></i> Create new project</a></li>
                <li><a href="/laravel/public/projects"><i class="fa fa-user-o" aria-hidden="true"></i> My projects</a></li>
